...
public class ComplaintRequestDTO {
	...
	public ComplaintRequestDTO(Integer complaintId, Instant dateOnRegister, String comment, String status, String email,
			int customerId, int driverId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ComplaintRequestDTO other = (ComplaintRequestDTO) obj;
	...
	public String toString() {
		return "ComplaintRequestDTO [complaintId=" + complaintId + ", dateOnRegister=" + dateOnRegister + ", comment="
